...
#   Connect components to the I2C port
if ("DISTANCE" in TEST_SET) or ("MOVE" in TEST_SET) or ("DISPLAY_DISTANCE" in TEST_SET):
    # Connect and initialize the URM09 device
    distance_sensor = DFRobot_URM09(wum.i2c)
if ("DISPLAY" in TEST_SET) or ("DISPLAY_DISTANCE" in TEST_SET):
